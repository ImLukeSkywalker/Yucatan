...
map.getView().fit([-9925863.346560, 2277275.999230, -9708930.028539, 2406334.683569], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Localidades Piloto en Yucatán</h2>';
        return titleElement;
    })(),
